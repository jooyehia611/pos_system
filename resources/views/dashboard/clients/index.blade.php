                ...
                <div class="box-header with-border">
                    ...
                    <form action="{{ route('dashboard.clients.index') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="search" class="form-control" style="border-radius: 10px" placeholder="@lang('site.search')" value="{{ request()->search }}">
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (auth()->user()->hasPermission('orders-create'))
                                            ...
                                            <a href="{{route('dashboard.clients.orders.create' , $client->id)}}" class="btn btn-primary btn-sm">@lang('site.addOrder')</a>

                                            @else

                                            <a href="#" class="btn btn-primary btn-sm disabled">@lang('site.addOrder')</a>
